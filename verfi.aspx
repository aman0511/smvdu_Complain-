<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="verfi.aspx.vb" Inherits="mycompalint.verfi" %>
   ...
   <div id ="header">
    ...
    <div class="CenterP" style="height:200px">
        ...
        <table style="margin: 0 auto;CELLPADDING:14px; CELLSPACING:12px">
            <tbody>
                <tr>
                    <td style="width:200px"><strong>verifiction code</strong></td>
        ...
        <asp:Label ID="Label1" runat="server" ForeColor="#FF3300" Width="375px"></asp:Label>
