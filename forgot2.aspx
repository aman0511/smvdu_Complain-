<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="forgot2.aspx.vb" Inherits="mycompalint.forgot2" %>
   ...
   <div class="CenterP" style="height:400px ; ">
        ...
        <table style="margin: 0 auto;CELLPADDING:14px; CELLSPACING:12px; padding-top:50px;">
            <tbody>
                ...
                <tr><td><strong>verifiction code</strong></td>
                    <td> <asp:TextBox ID="TextBox2" TextMode="password" runat="server"></asp:TextBox>
                        <asp:Label ID="wpass5" runat="server" ForeColor="Red" Width="200px"></asp:Label>
                    </td>
                </tr>
                 <tr>
