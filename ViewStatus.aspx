<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ViewStatus.aspx.vb" Inherits="mycompalint.ViewStatus" %>
...
<body>
   ...
   <div id ="header">
    ...
    <div class="CenterP" style="height:200px">
            ...
            <tbody>
                ...
                <tr><td><strong>Password</strong></td>
                    <td> <asp:TextBox ID="TextBox2" TextMode="password" runat="server"></asp:TextBox>
                        <asp:Label ID="wpass1" runat="server" ForeColor="Red"></asp:Label>
                    </td>
                </tr>
            </tbody>
        </table>
        ...
        <asp:Label ID="Lname" runat="server" Height="33px" Width="200px"></asp:Label>
        <asp:Label ID="Lemail" runat="server" Width="200px"></asp:Label>
        <asp:Label ID="Lstatus" runat="server" ValidateRequestMode="Enabled" ViewStateMode="Enabled" Width="225px"></asp:Label>
